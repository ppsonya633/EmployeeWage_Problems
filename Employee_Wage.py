...
class CompanyEmpWage:
    ...
    def update_details(self, wage_per_hour, max_working_days, max_working_hours):
        """
        Description:
            Update the wage per hour, maximum working days, and hours for the company.
        Parameters:
            wage_per_hour (int): New wage per hour for the company.
            max_working_days (int): New maximum number of working days per month.
            max_working_hours (int): New maximum number of working hours per month.
        Return:
            None
        """
        self.wage_per_hour = wage_per_hour
...
class EmpWageBuilder:
    ...
    def update_company_details(self, company_name):
        """
        Description:
            Update the wage per hour, maximum working days, and hours for a specific company.
        Parameters:
            company_name (str): Name of the company to be updated.
        Return:
            None
        """
        ...
        company = next((c for c in self.company_list if c.company_name == company_name), None)
        if company:
            wage_per_hour = int(input("Enter the new wage per hour: "))
            max_working_days = int(input("Enter the new maximum working days: "))
            max_working_hours = int(input("Enter the new maximum working hours: "))
            company.update_details(wage_per_hour, max_working_days, max_working_hours)
            print(f"Updated details for {company_name}.")
        else:
            print(f"Company {company_name} not found.")
    ...
    def compute_wages(self):
        """
        Description:
            Compute and print wages for all employees in all companies.
        Parameters:
            None
        Return:
            None
...
def main():
    ...
    while True:
        ...
        print("3. Update Company Details")
        print("4. Compute Wages for All Companies")
        print("5. Exit")
        ...
        match choice:
            ...
            case '3':
                company_name = input("Enter the company name to update details: ")
                builder.update_company_details(company_name)
            case '4':
